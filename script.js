document.querySelectorAll('nav a[href^="#"]').forEach(anchor => {
    anchor.addEventListener('click', function (e) {
      ...
      } else if (this.getAttribute('href') === '#video-section') {
        // Scroll to the section above the footer when clicking on "Alpha Team"
        const sectionAboveFooter = document.getElementById('video-section').previousElementSibling;
